...
local sql = "SELECT a.id fid,title,crt_date,status,b.div_env,b.src,b.to,b.ver,b.id eid FROM t_diversion b LEFT JOIN t_diversion_flow a ON a.div_id=b.id WHERE a.status>=4 and b.id="..eid;
