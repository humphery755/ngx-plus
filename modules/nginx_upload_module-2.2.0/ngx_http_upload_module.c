...
#if (NGX_OPENSSL || NGX_HAVE_OPENSSL_MD5_H)
#include <openssl/md5.h>
#else
#include <md5.h>
#endif

#if (NGX_OPENSSL || NGX_OPENSSL_MD5)
#define  MD5Init    MD5_Init
#define  MD5Update  MD5_Update
#define  MD5Final   MD5_Final
#endif

#if (NGX_OPENSSL || NGX_HAVE_OPENSSL_SHA1_H)
...
static ngx_int_t ngx_http_request_body_save_filter1(ngx_http_request_t *r, ngx_chain_t *in);
...
ngx_http_upload_merge_ranges(ngx_http_upload_ctx_t *u, ngx_http_upload_range_t *range_n) {
    ...
    if(out_buf.file_pos < state_file->info.st_size) {
        rc = ftruncate(state_file->fd, out_buf.file_pos);
    }
...
static ngx_int_t
ngx_http_request_body_save_filter1(ngx_http_request_t *r, ngx_chain_t *in)
{
#if (NGX_DEBUG)
    ngx_chain_t               *cl;
#endif
...
ngx_http_request_body_length_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    rc = ngx_http_request_body_save_filter1(r, out);
